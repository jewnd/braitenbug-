...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 12:48:24 2020
...
tau_rise = 2*ms
tau_decay = 1*ms
peaktime = ((tau_decay*tau_rise)/(tau_decay - tau_rise))*log(tau_decay/tau_rise)
g_synmaxval = g_synpk/((((tau_decay*tau_rise)/ms)/(tau_decay-tau_rise))*(exp(-peaktime/tau_decay)-exp(-peaktime/tau_rise)))
...
du/dt = a*(b*v - u)/ms : 1
dg_alpha/dt = (-g_alpha/(tau_decay/ms) + z)/ms : 1
dz/dt = (-z/(tau_rise/ms))/ms : 1
'''
